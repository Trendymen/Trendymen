...
var supports = function () {
    ...
    return function (f) {
        ...
        }), b = 0, c = e.length; c > b; b += 1)if (a = e[b] + f, "string" == typeof d[a])return !0;
        return !1
    }
}(), Slider = function (a) {
    "use strict";
    ...
    var b = {
        npos: 0, timer: null, config: function (a) {
            ...
            for (d.container.css({width: d.tWidth}), e.append(d.pager()), b = 0, c = d.max; c > b; b += 1)d.items(b + 1).insertBefore(a(".slider-nav .next").parents("li"));
            ...
            supports("transition") ? b.container.css({left: -b.npos * b.sWidth}) : b.container.animate({left: -b.npos * b.sWidth}, 800)
        }, bullets: function (a) {
