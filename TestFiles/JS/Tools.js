...
function drag(ele,callBack) {
    ...
    function release() {
        ...
        typeof callBack === "function" ? callBack() : "";  //在鼠标松开时，执行回调函数
    }
...
function ajax (method,url,data,callback,flag) {
    var xhr = new XMLHttpRequest() || new ActiveXObject("Microsoft.XmlDom ");
    ...
    xhr.onreadystatechange=function () {
        if(xhr.readyState === 4){
            return xhr.responseText?callback(xhr.responseText):"无数据";
        }else {
            return "xhr失败";
        }
