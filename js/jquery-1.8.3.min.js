...
(function (e, t) {
    ...
    function H(e, n, r) {
        if (r === t && e.nodeType === 1) {
            var i = "data.json-" + n.replace(P, "-$1").toLowerCase();
            r = e.getAttribute(i);
            if (typeof r == "string") {
                try {
            ...
            if (e === t) {
                if (this.length) {
                    ...
                    if (a.nodeType === 1 && !v._data(a, "parsedAttrs")) {
                        s = a.attributes;
                        for (u = s.length; f < u; f++) o = s[f].name, o.indexOf("data.json-") || (o = v.camelCase(o.substring(5)), H(a, o, l[o]));
    ...
    var ct = "abbr|article|aside|audio|bdi|canvas|data.js|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
